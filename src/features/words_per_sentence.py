...
train_df = pd.read_csv('../../data/training_set_rel3.tsv', delimiter='\t', usecols=train_cols, encoding = 'ISO-8859-1')
...
valid_df = pd.read_csv('../../data/valid_set.tsv', delimiter='\t', usecols=valid_cols, encoding = 'ISO-8859-1')
